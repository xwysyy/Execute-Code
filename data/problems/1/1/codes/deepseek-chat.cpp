...
- **Transition:** For each item, decide whether to include it or not based on whether it fits in the remaining capacity and whether it increases the total value.
