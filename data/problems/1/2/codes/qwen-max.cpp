...
int main() {
    ...
    // DP array to store the maximum value that can be achieved with a given capacity
    vector<int> dp(V + 1, 0);
    ...
    // The answer is the maximum value that can be achieved with the capacity V
    cout << dp[V] << endl;
